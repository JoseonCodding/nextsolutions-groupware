package com.kdt.KDT_PJT.sample.vo;

import java.math.BigDecimal;
import java.util.Date;

public class kdtCustInfoBascVO {
    ...
    // kdtCustInfoBasc 모델 복사
    public void CopyData(kdtCustInfoBascVO param)
    {
        this.custSn = param.getCustSn();
        this.kornFlnm = param.getKornFlnm();
        this.mblTelno = param.getMblTelno();
        this.emlAddr = param.getEmlAddr();
        this.frstRegDt = param.getFrstRegDt();
        this.frstRgtrSn = param.getFrstRgtrSn();
        this.lastChgDt = param.getLastChgDt();
        this.lastMdfrId = param.getLastMdfrId();
    }
