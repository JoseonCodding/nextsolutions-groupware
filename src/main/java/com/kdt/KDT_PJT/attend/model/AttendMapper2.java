...
public interface AttendMapper2 {
	...
	@Update("""
			    ...
			    WHERE employeeId = #{employeeId}
			      ...
			      AND state_type = '대기'
			""")
	int fixInByEmpAndDate(@Param("employeeId") String employeeId, @Param("workDate") String workDate, // yyyy-MM-dd
			@Param("modifiedAt") LocalDateTime modifiedAt, @Param("title") String title,
	...
	@Update("""
			    ...
			    WHERE employeeId = #{employeeId}
			      ...
			      AND state_type = '대기'
			""")
	int fixOutByEmpAndDate(@Param("employeeId") String employeeId, @Param("workDate") String workDate,
			@Param("modifiedAt") LocalDateTime modifiedAt, @Param("title") String title,
			@Param("modificationReason") String modificationReason);
	...
	@Select("""
			...
			""")
	int countAttendListHistory(@Param("startDay") String startDay, @Param("endDay") String endDay,
			@Param("empNm") String empNm, @Param("modifiedBy") String modifiedBy, @Param("stateType") String stateType);
}
