...
<link rel="stylesheet"
	href="/static_resources/css/schedule_todoList.css">
	...
	<div class="page-container main-content kc-container">
		...
		<div class="whole">
			...
			<ol class="breadcrumb bc-3 breadinfo">
				<li><a href="/sampleJspMvc/home" onclick="">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                $.ajax({
                    url: '/schedule/events',
                    type: 'POST', // 또는 'GET' (서버가 어떤 방식으로 받는지 확인 필요)
                    contentType: 'application/json',
                    data: JSON.stringify({}), // 빈 파라미터 전달
                    success: function(data) {
                        ...
                        allEvents = data.events
                            ...
                            .map(event => ({
                                ...
                                isVisible: true,
                                isReadOnly: event.calendarId !== 'personal',
